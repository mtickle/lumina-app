...
const DeepDiveDrawer = ({ isOpen, onClose, activeCard }) => {
  ...
  return (
    ...
    >
      ...
      {/* Sliding Drawer */}
      <div
        className={`absolute bottom-0 inset-x-0 h-[85dvh] bg-zinc-950 rounded-t-3xl shadow-2xl transition-transform duration-500 ease-out flex flex-col border-t border-zinc-800 ${
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 scroll-smooth hide-scrollbar">
          ...
          <div className="pb-12 h-full">
            {loading ? (
              ...
              <div className="overflow-y-auto p-4 pb-20 text-lg leading-relaxed text-zinc-300">
